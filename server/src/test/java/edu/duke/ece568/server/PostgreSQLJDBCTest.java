...
class PostgreSQLJDBCTest {
    ...
    public void test_PostgreSQLJDBC_TruckWareHouseShipment() {
        ...
        //Test Truck
        postgreSQLJDBC.addTruck(1L, 1, 2, new Status().tIdel, false,false);
        postgreSQLJDBC.addTruck(2L, 1, 2, new Status().tTraveling, false,false);
        postgreSQLJDBC.addTruck(3L, 1, 2, new Status().tArriveWarehouse, false,false);
        postgreSQLJDBC.addTruck(4L, 1, 2, new Status().tLoading, false,false);
        postgreSQLJDBC.addTruck(5L, 1, 2, new Status().tLoading, true,false);
        ...
        assertFalse(postgreSQLJDBC.getTruckIsSentUTruckArrived(1L));
        assertTrue(postgreSQLJDBC.getTruckIsSentUTruckArrived(5L));

        //Test Shipment
        postgreSQLJDBC.addShipment(1L,4L,5L,1L,"vcm@duke.edu",new Status().pInWarehouse,99L, UUID.randomUUID().toString());
        postgreSQLJDBC.addShipment(2L,4L,5L,1L,"vcm@duke.edu",new Status().pInWarehouse,99L,UUID.randomUUID().toString());
        postgreSQLJDBC.addShipment(3L,4L,5L,1L,"vcm@duke.edu",new Status().pInWarehouse,99L,UUID.randomUUID().toString());
        postgreSQLJDBC.addShipment(4L,4L,5L,1L,"vcm@duke.edu",new Status().pInWarehouse,99L,UUID.randomUUID().toString());
        ...
        //Test UGopickUp
        postgreSQLJDBC.addUGoPickup(3L,1L, 3L, 1L);
        ...
        postgreSQLJDBC.addShipment(1L,5L,6L,2L,"vcm@duke.edu",new Status().pInWarehouse,100L,UUID.randomUUID().toString());
        ...
        //Test UGoDeliver
        postgreSQLJDBC.addUGoDeliver(7L,2L);
